...
# array titik point pada formulir
per = 25
formDotSet = [
        # Data Peserta Didik
...
img_path = sys.argv[1]
imgQ = cv2.imread('C://xampp//htdocs//aplikasi_pakar_smpkp2//public//img//FormDatabaseSet.jpg')
...
json_data = json.dumps(myData, ensure_ascii=False)
