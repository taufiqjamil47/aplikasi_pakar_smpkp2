  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        loncat: 'animatedBounce 1s ease infinite alternate',
        textSlide: 'textSlide 15.5s cubic-bezier(0.83, 0, 0.17, 1) infinite',
        textSlide1: 'textSlide1 5s cubic-bezier(0.83, 0, 0.17, 1) infinite',
        textSlide2: 'textSlide2 7.5s cubic-bezier(0.83, 0, 0.17, 1) infinite',
        textSlide3: 'textSlide3 10s cubic-bezier(0.83, 0, 0.17, 1) infinite',
        textSlide4: 'textSlide4 12.5s cubic-bezier(0.83, 0, 0.17, 1) infinite',
        textSlide5: 'textSlide5 15s cubic-bezier(0.83, 0, 0.17, 1) infinite',
        textSlide6: 'textSlide6 17.5s cubic-bezier(0.83, 0, 0.17, 1) infinite',
        textSlide7: 'textSlide7 20s cubic-bezier(0.83, 0, 0.17, 1) infinite',
      },
    },
  },
  plugins: [],
