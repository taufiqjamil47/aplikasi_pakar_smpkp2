        ...
        <div class="w-full mx-auto">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="grid grid-cols-2 gap-6 mb-4">
                    <div
                        class="bg-gradient-to-r {{ $totalSiswa > 40 ? 'from-rose-500 to-red-700' : 'from-blue-500 to-indigo-600' }} px-6 py-3 rounded-br-lg">
                        <h2 class="text-2xl font-bold text-white">Detail {{ $kelas->nama_kelas }}</h2>
                        <p class="{{ $totalSiswa > 40 ? 'text-red-100' : 'text-blue-100' }} mt-1">
                            Halaman ini menampilkan informasi lengkap mengenai kelas
                            <strong>{{ $kelas->nama_kelas }}</strong>. <br><br>
                            Anda dapat melihat siapa wali kelas yang bertanggung jawab, serta menambahkan siswa baru ke
                            dalam kelas ini.
                            Gunakan fitur <em>drag-and-drop</em> untuk dengan mudah memindahkan siswa ke kelas ini secara
                ...
                <div
                    class="flex flex-col md:flex-row gap-6 {{ $totalSiswa > 50 ? 'pointer-events-none opacity-50' : '' }}">
                    <!-- Daftar Siswa (Kiri) -->
