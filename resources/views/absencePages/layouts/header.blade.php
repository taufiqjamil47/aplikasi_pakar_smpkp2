<header class="non-printable">
    <div
        class="transition-all duration-500 ease-in-out container w-full sm:w-[95%] mt-0 md:mt-3 m-auto bg-greyIsh pb-[1.2rem] lg:pb-0 pt-[1.2rem] px-[1.2rem] rounded-none sm:rounded-[10px]">
        <div
        ...
        <nav id="nav-menu"
            ...
            <ul class="lg:flex py-3">
                ...
                @can('userRole')
                    <li class="group text-slate-500"><a
                            class="{{ Request::is('ppdb/scan') ? 'active' : '' }} {{ Request::is('ppdb/upload') ? 'active' : '' }} gap-2 items-center text-base text-dark py-2 mx-5 flex group-hover:text-black"
                            href="/ppdb/scan">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor"
