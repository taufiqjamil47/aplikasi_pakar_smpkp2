<div
    ...
    <div class="menu flex gap-2 items-center">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            class="bi bi-rocket-takeoff fill-white hidden lg:block" viewBox="0 0 16 16">
            <path
        ...
        <span class="text-white hidden sm:block border-r-[2px] pr-3 text-sm">
            App Version {{ Illuminate\Foundation\Application::VERSION }}
        </span>
        <a href="#" id="arrow" class="menu flex gap-2 items-center text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                class="bi bi-person-circle h-8 w-8 sm:h-8 sm:w-8 md:w-7 md:h-7 lg:w-5 lg:h-5" viewBox="0 0 16 16">
