<div id="nav-menu"
        class="bg-blueColor hidden lg:block z-50 h-screen fixed md:sticky top-[70px] md:top-0 w-full sm:w-72  p-4 overflow-y-auto"
        aria-label="Sidebar">
        <div class="shadow-lg md:shadow-none px-3 py-4 overflow-y-auto rounded-[10px] bg-white dark:bg-gray-800">
            <ul class="space-y-2">
                <li>
                    <a href="#" class="active flex items-center p-2 text-base font-normal">
                ...
                <li class="arba-ujo">
                    ...
                    <ul id="dropdown-example" class="hidden py-2">
                        <li>
                            <a href="#"
                                class="flex items-center w-auto p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 ml-11">Surat
                                Permohonan</a>
                        </li>
                        <li>
                            <a href="#"
