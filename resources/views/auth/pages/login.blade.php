...
@section('content')
    <div class="flex flex-col lg:flex-row lg:h-screen justify-center items-center m-4 lg:my-0 gap-5 sm:gap-10">
        ...
        <div
            class="transition-all duration-500 ease-in-out transform hover:scale-[1.02] shadow-2xl bg-white px-6 py-4 w-full sm:w-96 lg:w-[30rem] h-auto lg:h-[36rem] rounded-xl text-slate-800 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <form action="{{ route('authenticate') }}" method="post" class="mt-2">
                    @csrf
                    <div class="mb-2">
                        <h2 class="font-bold text-3xl text-slate-800 mb-1">Masuk</h2>
                        <p class="text-slate-600">Silahkan masukkan Surel dan Kata Sandi Anda untuk melanjutkan.</p>
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#lupaSandi" class="text-sm text-blue-600 hover:text-blue-800 hover:underline">Lupa kata
                                sandi?</a>
                        </div>

                        <!-- Submit Button -->
                        <button type="submit"
                            class="bg-gradient-to-r from-blue-600 to-blue-500 h-12 rounded-lg text-white font-semibold shadow-md hover:shadow-lg hover:from-blue-700 hover:to-blue-600 transition-all duration-300 transform hover:-translate-y-0.5">
                            MASUK
                        </button>
                    </div>
                </form>
                ...
                <div class="text-center mt-5 text-sm text-slate-600">
                    Belum punya akun? <a href="/register"
                        class="font-medium text-blue-600 hover:text-blue-800 hover:underline">Daftar disini</a>
                </div>
                ...
                <div class="relative my-4">
                    ...
                    <div class="relative flex justify-center">
                        <span class="px-3 bg-white text-sm text-slate-500">Atau masuk dengan</span>
                    </div>
                </div>
                ...
                <!-- Footer -->
                <div class="mt-10 text-xs text-slate-500 text-center">
